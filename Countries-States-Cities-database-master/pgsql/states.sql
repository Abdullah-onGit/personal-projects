CREATE TABLE IF NOT EXISTS "Global"."StateMaster" (
  "StateMasterAutoId" serial NOT NULL primary key,
  "StateName" varchar(30) NOT NULL,
  "CountryMasterAutoId" integer NOT NULL DEFAULT '1' references "Global"."CountryMaster"("CountryMasterAutoId")
);

INSERT INTO "Global"."StateMaster" ("StateName","CountryMasterAutoId")  VALUES
